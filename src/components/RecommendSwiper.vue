<template>
  <div>
    <swiper :options="swiperOption" ref="mySwiper">
      <!-- slides -->
      <swiper-slide :key="item.index" v-for="item in indexblogData">
        <IndexBlog :foodPic="item.foodPic" :foodTitle="item.foodTitle" :foodDesc="item.foodDesc" :foodLikes="item.foodLikes" :foodCreateTime="item.foodCreateTime" :foodCollect="item.foodCollect"  :noteId="item.noteId" :name="names" :where="names">
        </IndexBlog>
      </swiper-slide>
      <!-- Optional controls -->
